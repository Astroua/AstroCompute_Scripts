...
Uncomment at line 644 if you want time-bins printed to screen.
Uncomment at line 1165 if you want light curve results printed to screen.
...
if remainder > rem_int:
	nums=numIntervals+1
	print 'The number of time bins is: ',nums
else:
	nums=numIntervals
	print 'The number of time bins is: ',nums
